...
## 9. Midterm Repo Readiness

- [x] Problem and target user
- [x] Product direction
- [x] MVP
- [x] Input dictionary
- [x] Sources
...
> Week 4 formalizes how player inputs are converted into portfolio value, floating funding cost, FX exposure, debt value, Net Wealth and final P&L, creating the financial logic required for the working MVP.
