...
| **Not included yet** | - Phase 1 (Tulip Mania) và Phase 2 (Thai Baht 1997).<br>- Bảng theo dõi số dư chi tiết từng giây trong lúc chơi.<br>- Chế độ chơi nhiều người (Multiplayer / PvP).<br>- Bảng xếp hạng trực tuyến (Online Leaderboard).<br>- Kết nối API dữ liệu thị trường trực tiếp. |- Hướng dẫn người chơi cách sử dụng và khai thác game.<br>
